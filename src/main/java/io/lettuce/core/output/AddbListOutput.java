...
/**
 * {@link List} of ADDB output.
 *
 * @author Doyoung Kim
 */
public class AddbListOutput<K, V> extends CommandOutput<K, V, List<K>> implements StreamingOutput<K> {

    private boolean initialized;
    private Subscriber<K> subscriber;

    public AddbListOutput(RedisCodec<K, V> codec) {
